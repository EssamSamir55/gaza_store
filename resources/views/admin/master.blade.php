...
<body id="page-top">
    ...
    <div class="colors">
        <button><i class="fas fa-palette" style="color: #d60505;"></i></button>
            <ul>
                ...
                <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
                    ...
                    <li class="nav-item dropdown no-arrow">
                            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
                                ...
                                <span class="mr-2 d-none d-lg-inline text-gray-600 small"><i class="fas fa-globe mr-1 ml-1"></i>{{ __('admin.langs') }}</span>
                            </a>
